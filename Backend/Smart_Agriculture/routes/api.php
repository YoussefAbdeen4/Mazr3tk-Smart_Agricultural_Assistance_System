...
use App\Http\Controllers\HandelFastapiController;
...
Route::post('plant-disease-detection',[HandelFastapiController::class,'plantDiseaseDetection']);
Route::post('pest-detection',[HandelFastapiController::class,'pestDetection']);
Route::post('crop_yield',[HandelFastapiController::class,'cropYield']);
